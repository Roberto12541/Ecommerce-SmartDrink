    ...
    return (
        <footer className="bg-black lg:grid lg:grid-cols-5">
            <div className="relative block h-32 lg:col-span-2 lg:h-full">
                <img
                    src="https://images.pexels.com/photos/340996/pexels-photo-340996.jpeg?cs=srgb&dl=pexels-isabella-mendes-340996.jpg&fm=jpg"
                    alt=""
                ...
                <div className="grid grid-cols-1 gap-8 sm:grid-cols-2" id="basico">
                    <div>
                        <p>
                            ...
                            <span href="#" className="block text-2xl font-medium text-white sm:text-3xl"> <a href="/nosotros#Contacto">Contáctanos</a></span>
                        </p>
